...
ITEM_TABLE: dict[str, TPItemData] = {
    ...
    "Piece of Heart": TPItemData("Heart", IC.usefull, 22, 45, 0x21),
    "Heart Container": TPItemData("Heart", IC.usefull, 23, 8, 0x22),
    ...
    "Hawkeye": TPItemData("Item", IC.usefull, 31, 1, 0x3E),
    ...
    "Empty Bomb Bag": TPItemData("Item", IC.progression, 43, 1, 0x50),
    "Goron Bomb Bag": TPItemData("Item", IC.progression, 44, 1, 0x51),
